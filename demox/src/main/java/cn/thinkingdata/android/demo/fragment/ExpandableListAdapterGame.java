...
import cn.gamedataeye.android.GameDataEyeExpandableListViewItemTrackProperties;
 ...
 */
public class ExpandableListAdapterGame extends BaseExpandableListAdapter
        implements GameDataEyeExpandableListViewItemTrackProperties {
    private static final String TAG = "NormalExpandableListAda";
    private String[] groupData;
    private String[][] childData;
    private OnGroupExpandedListener mOnGroupExpandedListener;

    public ExpandableListAdapterGame(String[] groupData, String[][] childData) {
