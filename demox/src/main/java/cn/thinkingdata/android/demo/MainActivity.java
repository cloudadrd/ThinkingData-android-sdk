...
import cn.gamedataeye.android.GameDataEyeTrackEvent;
...
//                TDTracker.getLightInstance().track("user_login", properties);
    ...
    // 清除 account id
    @GameDataEyeTrackEvent(eventName = "log_out", properties = "{\"paramString\":\"value\",\"paramNumber\":123,\"paramBoolean\":true}", appId = "debug-appid")
