...
interface DataEyeAnalyticsAPI {
     ...
     */
    void track(DataEyeAnalyticsEvent event);
     ...
     */
    void setDynamicSuperPropertiesTracker(DataEyeAnalyticsSDK.DynamicSuperPropertiesTracker dynamicSuperPropertiesTracker);
     ...
     */
    void setNetworkType(DataEyeAnalyticsSDK.ThinkingdataNetworkType type);
     ...
     */
    void enableAutoTrack(List<DataEyeAnalyticsSDK.AutoTrackEventType> eventTypeList);
     ...
     * @return SDK 实例
     */
    DataEyeAnalyticsAPI createLightInstance();
}
