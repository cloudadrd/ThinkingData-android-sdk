...
public class DataEyeDatabaseAdapter {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public DatabaseHelper(Context context, String name) {
            ...
            mMinimumDatabaseLimit = DataEyeContextConfig.getInstance(context).getMinimumDatabaseLimit();
        }
    ...
    private static final Map<Context, DataEyeDatabaseAdapter> sInstances = new HashMap<>();
    private final DatabaseHelper mDb;

    static DataEyeDatabaseAdapter getInstance(Context context) {
    ...
    DataEyeDatabaseAdapter(Context context) {
        this(context, DATABASE_NAME);
    }

    DataEyeDatabaseAdapter(Context context, String dbName) {
