...
public class ThinkingDataEncryptUtils {

    private static final String ALGORITHM_RSA = "RSA";
    private static final String ALGORITHM_AES = "AES";

    private static final String TAG = "ThinkingAnalytics.EncryptUtils";
    ...
    public static Pair<String, String> generateRSAKey() {
        try {
            ...
            TDLog.d(TAG, "generateRSAKey :" + e.getMessage());
            e.printStackTrace();
        }
    ...
    public static String rsaEncrypt(String publicKey, byte[] content) {
        ...
        try {
            ...
            ex.printStackTrace();
            TDLog.d(TAG, "rsaEncrypt :" + ex.getMessage());
        }
        return null;
    }
    ...
    public static byte[] rsaDecrypt(String priKey, String content) {
        try {
            ...
            TDLog.d(TAG, "rsaDecrypt :" + e.getMessage());
        }
        return null;
    }
    ...
    public static String aesEncrypt(byte[] key, String content) {
        ...
        try {
            ...
            TDLog.d(TAG, "aesEncrypt:" + ex.getMessage());
        }
        return null;
    }
    ...
    public static String aesDecrypt(byte[] key, String content) {
        ...
        try {
            ...
            TDLog.d(TAG, "aesDecrypt:" + ex.getMessage());
        }
