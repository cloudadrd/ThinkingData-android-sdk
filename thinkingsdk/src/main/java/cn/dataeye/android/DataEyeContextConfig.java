 ...
 */
class DataEyeContextConfig {
    private static final String KEY_MAIN_PROCESS_NAME = "cn.dataeye.android.MainProcessName";
    ...
    static DataEyeContextConfig getInstance(Context context) {
        synchronized (sInstanceMap) {
            DataEyeContextConfig contextConfig = sInstanceMap.get(context);
            if (null == contextConfig) {
                contextConfig = new DataEyeContextConfig(context);
    ...
    private DataEyeContextConfig(Context context) {
