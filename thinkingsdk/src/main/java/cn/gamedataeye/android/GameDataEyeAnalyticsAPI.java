...
interface GameDataEyeAnalyticsAPI {
    /**
     ...
     */
    void track(GameDataEyeAnalyticsEvent event);
     ...
     */
    void setDynamicSuperPropertiesTracker(GameDataEyeAnalyticsSDK.DynamicSuperPropertiesTracker dynamicSuperPropertiesTracker);
     ...
     */
    void setNetworkType(GameDataEyeAnalyticsSDK.ThinkingdataNetworkType type);
     ...
     */
    void enableAutoTrack(List<GameDataEyeAnalyticsSDK.AutoTrackEventType> eventTypeList);
     ...
     * @return SDK 实例
     */
    GameDataEyeAnalyticsAPI createLightInstance();
}
