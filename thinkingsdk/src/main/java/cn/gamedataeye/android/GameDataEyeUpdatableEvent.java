 ...
 */
public class GameDataEyeUpdatableEvent extends GameDataEyeAnalyticsEvent {
    private final String mEventId;

    public GameDataEyeUpdatableEvent(String eventName, JSONObject properties, String eventId) {
