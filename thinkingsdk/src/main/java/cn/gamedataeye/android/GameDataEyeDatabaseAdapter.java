...
public class GameDataEyeDatabaseAdapter {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public DatabaseHelper(Context context, String name) {
            ...
            mMinimumDatabaseLimit = GameDataEyeContextConfig.getInstance(context).getMinimumDatabaseLimit();
        }
    ...
    private static final Map<Context, GameDataEyeDatabaseAdapter> sInstances = new HashMap<>();
    private final DatabaseHelper mDb;

    static GameDataEyeDatabaseAdapter getInstance(Context context) {
        synchronized (sInstances) {
            final Context appContext = context.getApplicationContext();
            GameDataEyeDatabaseAdapter ret;
            if (! sInstances.containsKey(appContext)) {
                ret = new GameDataEyeDatabaseAdapter(appContext);
    ...
    GameDataEyeDatabaseAdapter(Context context) {
        this(context, DATABASE_NAME);
    }

    GameDataEyeDatabaseAdapter(Context context, String dbName) {
