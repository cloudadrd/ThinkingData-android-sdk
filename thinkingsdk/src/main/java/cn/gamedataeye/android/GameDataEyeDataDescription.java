 ...
 * TD 数据类
 */
class GameDataEyeDataDescription {
    ...
    GameDataEyeDataDescription(GameDataEyeAnalyticsSDK instance, DataEyeConstants.DataType type, JSONObject properties, ITime time) {
        mType = type;
