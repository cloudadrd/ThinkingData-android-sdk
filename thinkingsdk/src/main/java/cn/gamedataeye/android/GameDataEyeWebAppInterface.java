...
public class GameDataEyeWebAppInterface {
    ...
    private final GameDataEyeAnalyticsSDK defaultInstance;
    ...
    GameDataEyeWebAppInterface(GameDataEyeAnalyticsSDK instance) {
