 ...
 */
public class GameDataEyeRuntimeBridge {
    ...
    private static void trackFragmentViewScreen(final Object fragment) {
        GameDataEyeAnalyticsSDK.allInstances(new GameDataEyeAnalyticsSDK.InstanceProcessor() {
            @Override
            public void process(GameDataEyeAnalyticsSDK instance) {
                if (!instance.isTrackFragmentAppViewScreenEnabled()) {
                    return;
                }

                GameDataEyeIgnoreTrackAppViewScreen gameDataEyeIgnoreTrackAppViewScreen =
                        fragment.getClass().getAnnotation(GameDataEyeIgnoreTrackAppViewScreen.class);
                if (gameDataEyeIgnoreTrackAppViewScreen != null &&
                        (TextUtils.isEmpty(gameDataEyeIgnoreTrackAppViewScreen.appId()) ||
                                instance.getToken().equals(gameDataEyeIgnoreTrackAppViewScreen.appId()))) {
                    return;
                }
                ...
                try {
                    ...
                    if (fragment instanceof GameDataEyeScreenAutoTracker) {
                        GameDataEyeScreenAutoTracker gameDataEyeScreenAutoTracker = (GameDataEyeScreenAutoTracker) fragment;
                        ...
                        GameDataEyeAutoTrackAppViewScreenUrl autoTrackAppViewScreenUrl =
                                fragment.getClass().getAnnotation(GameDataEyeAutoTrackAppViewScreenUrl.class);
    ...
    public static void trackEvent(final Object trackEvent) {
        if (!(trackEvent instanceof GameDataEyeTrackEvent)) {
            return;
        }

        final String eventName = ((GameDataEyeTrackEvent) trackEvent).eventName();
        final String propertiesString = ((GameDataEyeTrackEvent) trackEvent).properties();
        final String token = ((GameDataEyeTrackEvent) trackEvent).appId();
        ...
        GameDataEyeAnalyticsSDK.allInstances(new GameDataEyeAnalyticsSDK.InstanceProcessor() {
            ...
            public void process(GameDataEyeAnalyticsSDK instance) {
                try {
                    ...
                    if (instance.isAutoTrackEventTypeIgnored(GameDataEyeAnalyticsSDK.AutoTrackEventType.APP_CLICK)) {
                        return;
                    }


                    if (null != annotation) {
                        if (annotation instanceof GameDataEyeIgnoreTrackOnClick) {
                            GameDataEyeIgnoreTrackOnClick ignoreTrackOnClick = (GameDataEyeIgnoreTrackOnClick) annotation;
                            if (TextUtils.isEmpty(ignoreTrackOnClick.appId()) || instance.getToken().equals(ignoreTrackOnClick.appId())) {
                                return;
                            }
                        } else if (annotation instanceof GameDataEyeTrackViewOnClick) {
                            GameDataEyeTrackViewOnClick trackViewOnClick = (GameDataEyeTrackViewOnClick) annotation;
        ...
        GameDataEyeAnalyticsSDK.allInstances(new GameDataEyeAnalyticsSDK.InstanceProcessor() {
            ...
            public void process(GameDataEyeAnalyticsSDK instance) {
                try {
                    ...
                    if (listAdapter != null) {
                        if (listAdapter instanceof GameDataEyeExpandableListViewItemTrackProperties) {
                            try {
                                GameDataEyeExpandableListViewItemTrackProperties trackProperties = (GameDataEyeExpandableListViewItemTrackProperties) listAdapter;
        ...
        GameDataEyeAnalyticsSDK.allInstances(new GameDataEyeAnalyticsSDK.InstanceProcessor() {
            ...
            public void process(GameDataEyeAnalyticsSDK instance) {
                try {
                    ...
                    if (adapter instanceof GameDataEyeAdapterViewItemTrackProperties) {
                        try {
                            GameDataEyeAdapterViewItemTrackProperties objectProperties = (GameDataEyeAdapterViewItemTrackProperties) adapter;
    ...
    private static boolean isViewIgnored(GameDataEyeAnalyticsSDK instance, Class viewType) {
        try {
            if (viewType == null) {
                return true;
            }
    ...
    private static boolean isViewIgnored(GameDataEyeAnalyticsSDK instance, View view) {
        try {
            if (view == null) {
                return true;
            }
