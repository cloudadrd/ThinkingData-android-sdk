...
class GameDataEyeSystemInformation {
    ...
    private static String sLibVersion = GameDataEyeConfig.VERSION;
    private static long fit = 0;
    private static GameDataEyeSystemInformation sInstance;
    ...
    static GameDataEyeSystemInformation getInstance(Context context) {
        synchronized (sInstanceLock) {
            if (null == sInstance) {
                sInstance = new GameDataEyeSystemInformation(context);
            }
            return sInstance;
        }
    }
    ...
    private GameDataEyeSystemInformation(Context context) {
