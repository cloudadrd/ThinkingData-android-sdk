...
import cn.gamedataeye.android.utils.DataEyeConstants.DataType;
...
public class BasicTest {
    ...
    private static GameDataEyeConfig mConfig;

    @Before
    public void setUp() {
        GameDataEyeAnalyticsSDK.enableTrackLog(true);
        mAppContext = ApplicationProvider.getApplicationContext();
        mConfig = GameDataEyeConfig.getInstance(mAppContext, TA_APP_ID, TA_SERVER_URL);
    }
    ...
    public void trackBasic() throws InterruptedException, JSONException {
        ...
        GameDataEyeAnalyticsSDK instance = new GameDataEyeAnalyticsSDK(mConfig) {
            @Override
            protected GameDataEyeDataHandle getDataHandleInstance(Context context) {
                return new GameDataEyeDataHandle(context) {
                    @Override
    ...
    public void testSuperProperties() throws InterruptedException, JSONException {
        ...
        instance.setDynamicSuperPropertiesTracker(
                new GameDataEyeAnalyticsSDK.DynamicSuperPropertiesTracker() {
                    @Override
    ...
    public void testAutomaticData() throws InterruptedException, JSONException {
        ...
        assertEquals(automaticData.getString("#lib_version"), GameDataEyeConfig.VERSION);
    ...
    public void testCalibrateTime() throws JSONException, InterruptedException, ParseException {
        ...
        GameDataEyeAnalyticsSDK.calibrateTime(timestamp);
        assertTime(instance, messages, timestamp);
    }

    private void assertTime(GameDataEyeAnalyticsSDK instance, final BlockingQueue<JSONObject> messages, long timestamp)
    ...
    public void testUniqueEvent() throws JSONException, InterruptedException, ParseException {
        ...
        instance.track(new GameDataEyeFirstEvent("test_unique", null));
        JSONObject event = messages.poll(POLL_WAIT_SECONDS, TimeUnit.SECONDS);
        assertEquals(event.getString("#type"), "track");
        ...
        instance.track(new GameDataEyeFirstEvent("test_unique", eventProp));
        event = messages.poll(POLL_WAIT_SECONDS, TimeUnit.SECONDS);
        assertEquals(event.getString("#type"), "track");
        assertEquals(event.getString("#event_name"), "test_unique");
        assertEquals(event.getString("#first_check_id"), instance.getDeviceId());
        ...
        GameDataEyeFirstEvent uniqueEvent = new GameDataEyeFirstEvent("test_unique", eventProp);
        ...
        GameDataEyeFirstEvent uniqueEvent1 = new GameDataEyeFirstEvent("test_unique", eventProp);
        ...
        GameDataEyeFirstEvent uniqueEvent2 = new GameDataEyeFirstEvent("test_unique", eventProp);
    ...
    public void testUpdatableEvent() throws JSONException, InterruptedException, ParseException {
        ...
        instance.track(new GameDataEyeUpdatableEvent("test_update", null, null));
        JSONObject event = messages.poll(POLL_WAIT_SECONDS, TimeUnit.SECONDS);
        ...
        instance.track(new GameDataEyeUpdatableEvent("test_update", null, ""));
        event = messages.poll(POLL_WAIT_SECONDS, TimeUnit.SECONDS);
        assertEquals(event.getString("#type"), "track_update");
        assertEquals(event.getString("#event_name"), "test_update");
        ...
        JSONObject eventProp = generateEventProperties();
        instance.track(new GameDataEyeUpdatableEvent("test_update", eventProp, eventId));
        event = messages.poll(POLL_WAIT_SECONDS, TimeUnit.SECONDS);
        assertEquals(event.getString("#type"), "track_update");
        assertEquals(event.getString("#event_name"), "test_update");
    ...
    public void testOverWritableEvent() throws JSONException, InterruptedException, ParseException {
        ...
        instance.track(new GameDataEyeOverWritableEvent("test_overwrite", null, null));
        JSONObject event = messages.poll(POLL_WAIT_SECONDS, TimeUnit.SECONDS);
        ...
        instance.track(new GameDataEyeOverWritableEvent("test_overwrite", null, ""));
        event = messages.poll(POLL_WAIT_SECONDS, TimeUnit.SECONDS);
        assertEquals(event.getString("#type"), "track_overwrite");
        assertEquals(event.getString("#event_name"), "test_overwrite");
        assertEquals(event.getString("#event_id"), "");
        ...
        String eventId = "sample_event_id";
        JSONObject eventProp = generateEventProperties();
        instance.track(new GameDataEyeOverWritableEvent("test_overwrite", eventProp, eventId));
        event = messages.poll(POLL_WAIT_SECONDS, TimeUnit.SECONDS);
        assertEquals(event.getString("#type"), "track_overwrite");
        assertEquals(event.getString("#event_name"), "test_overwrite");
        assertEquals(event.getString("#event_id"), eventId);
