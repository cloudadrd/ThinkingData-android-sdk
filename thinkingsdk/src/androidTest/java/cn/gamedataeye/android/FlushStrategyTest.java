...
public class FlushStrategyTest {
    ...
    public void setUp() {
        ...
        mGameDataEyeSystemInformation = GameDataEyeSystemInformation.getInstance(mAppContext);
    ...
    private void assertAutomaticData(JSONObject automaticData) throws JSONException {
        ...
        Map<String, Object> deviceInfo = mGameDataEyeSystemInformation.getDeviceInfo();
                ...
                return new GameDataEyeDataHandle(context) {
                    ...
                    protected RemoteService getPoster() {
                        return new RemoteService() {
                            @Override
                            public String performRequest(String endpointUrl, String params, boolean debug, SSLSocketFactory sslSocketFactory, Map<String, String> extraHeaders) throws IOException, ServiceUnavailableException {
                                try {
    ...
    public void testFlushIntervalMultiAppId() throws InterruptedException, JSONException {
        ...
        GameDataEyeAnalyticsSDK instance_debug = new GameDataEyeAnalyticsSDK(GameDataEyeConfig.getInstance(mAppContext, TA_APP_ID_DEBUG, TA_SERVER_URL)) {
            @Override
            protected GameDataEyeDataHandle getDataHandleInstance(Context context) {
                return gameDataEyeDataHandle;
            }
